...
const questions = [
  ...
  {
    id: 2,
    question: "Do you have an automated booking management system?",
    options: ["Yes", "No"],
  },
  {
    id: 3,
  ...
  {
    id: 4,
    question: "Do you collect and analyze customer feedback systematically?",
    options: ["Yes", "No"],
  },
  {
    id: 5,
    question: "Do you have integrated marketing and analytics tools?",
    options: ["Yes", "No"],
  },
]
            ...
            <CardContent className="p-8 relative z-10">
              ...
              <div className="text-center mb-8">
                ...
                >
                  <Progress
                    ...
                    aria-label={`Progress: Step ${currentStep + 1} of ${questions.length}`}
                    role="progressbar"
              ...
              <AnimatePresence>
                {isLoading && (
                  ...
                  >
                    <LoadingSpinner size="md" text="Analyzing your responses..." />
                  </motion.div>
                )}
              </AnimatePresence>
                      ...
                      {currentQuestion.options.map((option, index) => (
                        ...
                        >
                          <button
                            ...
                            className={`w-full p-4 text-left rounded-lg border-2 transition-all duration-300 relative overflow-hidden group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
